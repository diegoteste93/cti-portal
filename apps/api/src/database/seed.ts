...
async function seed() {
  ...
  const sourceSeedData = [
    ...
    {
      name: 'Ransomware.live - Recent Cyber Attacks',
      type: SourceType.GENERIC_API,
      url: 'https://api.ransomware.live/v2/recentcyberattacks',
      scheduleCron: '0 */3 * * *',
      categorySlug: 'ransomware',
      mappingConfigJson: {
        titleField: 'description',
        summaryField: 'activity',
        contentField: 'group_name',
        urlField: 'web',
        dateField: 'date',
      },
    },
    ...
    {
      name: 'Abuse.ch URLhaus Recent Payloads',
      type: SourceType.GENERIC_API,
      ...
      mappingConfigJson: {
        ...
        summaryField: 'file_type',
        contentField: 'response_md5',
        urlField: 'urlhaus_reference',
        dateField: 'firstseen',
      },
      headersJson: {
    ...
    {
      name: 'CERT.br - Notícias',
      type: SourceType.RSS,
      url: 'https://www.cert.br/rss/',
      scheduleCron: '0 */4 * * *',
      categorySlug: 'general',
    },
    {
    ...
    {
      name: 'CTIR Gov (GSI) - Notícias',
      type: SourceType.RSS,
      url: 'https://www.gov.br/gsi/pt-br/assuntos/noticias/rss',
      scheduleCron: '0 */6 * * *',
      categorySlug: 'general',
    },
    {
      name: 'CISO Advisor Brasil',
      type: SourceType.RSS,
  ...
  for (const s of sourceSeedData) {
    ...
    if (!existing) {
      ...
      const source = sourceRepo.create({
        ...
        mappingConfigJson: s.mappingConfigJson,
